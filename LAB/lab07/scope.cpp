...
int main()
{
...

    {
        ...
        cout << "LIST THE IDENTIFIERS THAT are active here\n area, radius are active here" << endl;
        cout << "area = " << area << endl << "radius = " << radius << "PI = " << PI << " RATE = " << RATE << endl << endl;   
...

    {
        ...
        cout << "radus = " << radius << endl << "circumference = " << circumference << "PI = " << PI << " RATE = " << RATE << endl << endl;
...
void findArea(float rad, float& answer)
{
    ...
    cout << "LIST THE IDENTIFIERS THAT are active here\n rad, area are active here" << endl;
    cout << "rad = " << rad << endl << "answer = " << answer << "PI = " << PI << " RATE = " << RATE << endl << endl;
...
void findCircumference(float length, float& distance)
{
    ...
    cout << "LIST THE IDENTIFIERS THAT are active here" << endl;
    cout << "Length = " << length << " Distance = " << distance << "PI = " << PI << " RATE = " << RATE << endl << endl;
